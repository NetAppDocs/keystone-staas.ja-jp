...
* *サービスレベルアグリーメント*：このステータスは、少なくとも1つのサブスクリプションにNetAppとの有効なSustainability Service Level Agreement（SLA;持続可能性サービスレベルアグリーメント）がある場合に表示されます。ステータスは、サブスクリプションがSLAで定義された持続可能性基準を満たしているかどうかを示します。サブスクリプションがSLA条件を満たしている場合、ステータスは_ALL OK_と表示されます。
